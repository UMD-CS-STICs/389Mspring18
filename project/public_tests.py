import numpy as np
from histfilter import HistogramFilter
...
def test_move():
    ...
    correct = np.array(
        [[0.00000000e+00, 0.00000000e+00, 0.00000000e+00, 0.00000000e+00, 0.00000000e+00, 0.00000000e+00],
         [0.00000000e+00, 0.00000000e+00, 5.59269337e-13, 3.29315482e-09, 3.29371409e-09, 3.29315482e-09],
         [0.00000000e+00, 0.00000000e+00, 1.69798993e-04, 9.99830198e-01, 9.99999997e-01, 9.99830198e-01],
         [0.00000000e+00, 0.00000000e+00, 1.69798994e-04, 9.99830201e-01, 1.00000002e+00, 9.99830221e-01],
         [0.00000000e+00, 0.00000000e+00, 1.69798994e-04, 1.00067920e+00, 5.99932079e+00, 6.99864160e+00],
...
def test_sense():
    ...
    correct = np.array(
        [[1.07307687e-06, 1.07126166e-04, 2.14493697e-03, 5.82993552e-03, 2.14493697e-03, 1.07126166e-04],
         [1.48037381e-05, 2.14493697e-03, 4.30754611e-02, 1.17090636e-01, 4.30754611e-02, 2.14493697e-03],
         [3.96330630e-05, 5.82993552e-03, 1.17090636e-01, 3.18284739e-01, 1.17090636e-01, 5.82993552e-03],
         [1.48037381e-05, 2.14493697e-03, 4.30754611e-02, 1.17090636e-01, 4.30754611e-02, 2.14493697e-03],
         [1.07307687e-06, 1.07126166e-04, 2.14493697e-03, 5.82993552e-03, 2.14493697e-03, 1.07126166e-04],
